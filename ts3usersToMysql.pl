...
# CREATE TABLE IF NOT EXISTS `munin`.`ts3top` (`CLDBID` INT NOT NULL ,  `CLNAME` VARCHAR(64) NOT NULL ,  `Minutes` BIGINT,  PRIMARY KEY (`CLDBID`)) ENGINE = InnoDB DEFAULT CHARACTER SET = u$
